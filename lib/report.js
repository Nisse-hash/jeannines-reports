...
function retailAllTable(items, id) {
  ...
  const seeAllBtn = sorted.length > INITIAL ? `
    <div style="text-align:center;margin-top:14px;">
      ...
      })()" style="background:transparent;border:1px solid #C9A84C44;color:#C9A84C;padding:8px 24px;border-radius:6px;cursor:pointer;font-size:13px;font-weight:600;letter-spacing:.5px;">See all ${sorted.length} items ↓</button>
    </div>` : '';
  return `
    <table class="data-table" id="${id}">
...
.weather-loc{font-size:.6rem;color:#555;text-transform:uppercase;letter-spacing:.5px;font-weight:700;margin-bottom:.35rem}
