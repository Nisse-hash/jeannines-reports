...
function weatherStrip(weather) {
  ...
  return `<div class="weather-strip">
    ...
    <span class="weather-temp">${weather.tempHighF}°F high &nbsp;·&nbsp; ${weather.tempLowF}°F low</span>
  </div>`;
}
...
/* Weather strip */
.weather-strip{background:#13131A;border-radius:8px;padding:.875rem 1.25rem;margin-bottom:1.25rem;text-align:center}
.weather-emoji{font-size:1.5rem;vertical-align:middle}
.weather-desc{font-size:.95rem;font-weight:700;color:#fff;margin-left:.6rem;vertical-align:middle}
.weather-temp{font-size:.85rem;color:#999;margin-left:.9rem;vertical-align:middle}
