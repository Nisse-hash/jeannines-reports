...
<tr><td style="padding:0 0 10px 0;">
  <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;">
    <tr><td colspan="${cols.length}" style="padding:12px 16px 4px;color:#555555;font-size:11px;font-weight:700;letter-spacing:.5px;text-transform:uppercase;">Weather &mdash; 1 State St</td></tr>
    <tr>
