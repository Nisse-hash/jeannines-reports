...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;padding:24px 22px 18px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td width="50%" style="color:#555555;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">EMPLOYEE</td>
      <td width="30%" style="color:#555555;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">SHIFT &amp; OT</td>
      <td align="right" width="20%" style="color:#555555;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">EXTRA COST</td>
    </tr>`;
    for (const emp of labor.overtime) {
      ...
      html += `
    <tr>
      <td style="padding:14px 12px 14px 0;border-bottom:1px solid #1a1a1a;">
        <div style="color:#FFFFFF;font-size:18px;font-weight:700;">${emp.name}${dtBadge}</div>
        <div style="color:#555555;font-size:13px;margin-top:4px;">${fmt$(emp.wage)}/h</div>
      </td>
      <td style="padding:14px 8px;border-bottom:1px solid #1a1a1a;white-space:nowrap;">
        <span style="color:#999999;font-size:18px;">${emp.hours}h</span>
        <span style="color:#C9A84C;font-size:18px;font-weight:700;margin-left:6px;">${fmtOT(emp.otHours)}</span>
      </td>
      <td align="right" style="color:#C9A84C;font-size:18px;font-weight:700;padding:14px 0;border-bottom:1px solid #1a1a1a;white-space:nowrap;">+${fmt$(emp.extraCost)}</td>
    </tr>`;
    }
    html += `
    <tr>
      <td colspan="2" style="color:#666666;font-size:14px;padding:14px 0 4px;">Total extra labor cost</td>
      <td align="right" style="color:#C9A84C;font-size:19px;font-weight:700;padding:14px 0 4px;white-space:nowrap;">+${fmt$(labor.totalOtCost)}</td>
    </tr>
  </table>
</td></tr>
<tr><td style="height:20px;"></td></tr>`;
...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;padding:24px 22px 14px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    ...
    sales.topItems.slice(0, 20).forEach((item, i) => {
      html += `
    <tr>
