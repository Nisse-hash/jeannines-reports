...
<tr><td style="height:20px;"></td></tr>`;
  ...
  // WEATHER — hour-by-hour table 7am–3pm
...
<tr><td style="padding:0 0 10px 0;">
  <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;">
    <tr>
      ${cols.map(c => `<td align="center" width="${pct}" style="padding:14px 2px 6px;color:#888888;font-size:11px;font-weight:700;letter-spacing:.5px;">${c.label}</td>`).join('\n      ')}
    </tr>
    <tr>
...
<tr><td align="center" style="padding:20px 0 4px;">
  <div style="color:#333333;font-size:11px;">Jeannine's Restaurant &amp; Bakery &middot; Santa Barbara, CA</div>
</td></tr>
