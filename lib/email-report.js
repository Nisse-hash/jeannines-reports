...
export function generateEmailHtml(data, displayDate, reportUrl, chartUrls = null, weather = null, linkToken = null) {
...
<tr><td style="height:10px;"></td></tr>`;
    ...
    const laborPct = (sales.netSales > 0 ? (labor.totalLaborCost / sales.netSales * 100).toFixed(1) : '0.0') + '%';
    const laborLabel = `Labor / Sales<br><span style="color:#555555;font-size:10px;font-weight:400;letter-spacing:0;text-transform:none;line-height:1.5;">+ cleaning crew remaining after this report is sent</span>`;
    html += `
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0">
    ...
    ${metricRow('Tips', fmt$(sales.tipTotal), laborLabel, laborPct)}
  </table>
</td></tr>
<tr><td style="height:20px;"></td></tr>`;
