...
export function generateEmailHtml(data, displayDate, reportUrl, chartUrl = null, weather = null, linkToken = null) {
...
<tr><td style="padding:${li === 0 ? '0' : '16px'} 0 14px;">
      ...
      <td valign="top" style="padding-left:${hasOT ? '5px' : '0'};">
        <table width="100%" cellpadding="14" cellspacing="0" bgcolor="#1e1a0a" style="background-color:#1e1a0a;border-radius:6px;border-left:3px solid ${locColor};">
          <tr><td>
            ...
            <div style="color:${locColor};font-size:13px;margin-top:3px;">CA liability risk</div>
          </td></tr>
        </table>
      </td>`;
      html += `
...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;padding:24px 22px 14px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr style="border-top:2px solid #333333;">
      ...
      <td align="right" style="color:#FFFFFF;font-size:14px;font-weight:700;padding:12px 4px 8px;border-top:2px solid #333333;white-space:nowrap;">${locRetailTotalQty}</td>
      <td align="right" style="color:${locColor};font-size:14px;font-weight:700;padding:12px 0 8px 4px;border-top:2px solid #333333;white-space:nowrap;">${fmt$(locRetailTotalRev)}</td>
    </tr>
  </table>
</td></tr>
<tr><td style="height:20px;"></td></tr>`;
...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;padding:24px 22px 14px;">
  <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td align="right" style="color:#FFFFFF;font-size:14px;font-weight:700;padding:12px 4px 8px;border-top:2px solid #333333;white-space:nowrap;">${combinedRetailTotalQty}</td>
      <td align="right" style="color:#C9A84C;font-size:14px;font-weight:700;padding:12px 0 8px 4px;border-top:2px solid #333333;white-space:nowrap;">${fmt$(combinedRetailTotalRev)}</td>
    </tr>
  </table>
</td></tr>
<tr><td style="height:20px;"></td></tr>`;
