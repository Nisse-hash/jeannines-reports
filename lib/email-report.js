...
<tr><td style="height:10px;"></td></tr>`;
  ...
  // PEAK HOUR — larger text
  if (peakLine) {
    html += `
<!-- PEAK HOUR -->
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:6px;padding:16px 20px;">
  <div style="color:#666666;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:8px;">Day at a Glance</div>
