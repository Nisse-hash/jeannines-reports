...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:10px;padding:24px 22px 18px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td width="42%" style="color:#555555;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">EMPLOYEE</td>
      <td align="right" width="14%" style="color:#555555;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">SHIFT</td>
      <td align="right" width="22%" style="color:#C9A84C;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">OT</td>
      <td align="right" width="22%" style="color:#555555;font-size:13px;font-weight:700;letter-spacing:1px;padding-bottom:12px;border-bottom:1px solid #222222;">COST</td>
    </tr>`;
    ...
    <tr>
      ...
      <td align="right" style="color:#C9A84C;font-size:18px;font-weight:700;padding:14px 4px;border-bottom:1px solid #1a1a1a;white-space:nowrap;">${fmtOT(emp.otHours)}</td>
    ...
    html += `
    <tr>
      <td colspan="3" style="color:#666666;font-size:14px;padding:14px 0 4px;">Total extra labor cost</td>
