...
<tr><td style="height:10px;"></td></tr>`;
    ...
    const laborNote = `<span style="font-size:11px;font-weight:400;color:#888888;line-height:1.35;">Bakery (9 people)<br>Restaurant Staff<br>Restaurant Cleaning Staff<br>Maintenance Staff</span>`;
    html += `
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0">
