...
<tr><td style="height:10px;"></td></tr>`;
    ...
    const laborNote = `<span style="font-size:9px;color:#888888;line-height:1;">${managerName ? `<span style="color:#666666;font-weight:600;">${managerName}</span> &nbsp;&middot;&nbsp; ` : ''}Staff &middot; Cleaning &middot; Bakery (9) &middot; Maint.</span>`;
    html += `
