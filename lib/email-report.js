import { generateChartGif } from './chart-gif.js';
...
function metricRow(label1, value1, label2, value2) {
  return `<tr>
    <td width="50%" valign="top" style="padding:4px 4px 4px 0;">
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#13131A" style="background-color:#13131A;border-radius:6px;">
        <tr><td style="padding:16px 18px;">
          <div style="color:#888888;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px;">${label1}</div>
          <div style="color:#FFFFFF;font-size:22px;font-weight:700;">${value1}</div>
        </td></tr>
      </table>
    </td>
    <td width="50%" valign="top" style="padding:4px 0 4px 4px;">
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#13131A" style="background-color:#13131A;border-radius:6px;">
        <tr><td style="padding:16px 18px;">
          <div style="color:#888888;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px;">${label2}</div>
          <div style="color:#FFFFFF;font-size:22px;font-weight:700;">${value2}</div>
        </td></tr>
      </table>
    </td>
  </tr>`;
...
export async function generateEmailHtml(data, displayDate, reportUrl) {
  ...
  // Chart: fetch PNG buffer, embed as CID inline attachment (works in all email clients)
  const chartBuffer = await generateChartGif(ts);
  const chartCid = 'chart@jeannines';
...
<!-- HEADER -->
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:8px;padding:22px 24px 22px;">
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top">
        ...
        <div style="font-size:11px;color:#555555;">Generated ${now} PT</div>
      </td>
...
<tr><td style="height:10px;"></td></tr>`;
  ...
  if (labor.overtime?.length) {
    ...
    html += `
<!-- OVERTIME TABLE -->
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:8px;padding:16px 18px 12px;">
  <div style="color:#C9A84C;font-size:13px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:14px;">Overtime &mdash; ${labor.otCount} Employee${labor.otCount !== 1 ? 's' : ''}</div>
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td width="50%" style="color:#555555;font-size:10px;font-weight:700;letter-spacing:1px;padding-bottom:8px;border-bottom:1px solid #222222;">EMPLOYEE</td>
      <td width="30%" style="color:#555555;font-size:10px;font-weight:700;letter-spacing:1px;padding-bottom:8px;border-bottom:1px solid #222222;">SHIFT &amp; OT</td>
      <td align="right" width="20%" style="color:#555555;font-size:10px;font-weight:700;letter-spacing:1px;padding-bottom:8px;border-bottom:1px solid #222222;">EXTRA COST</td>
    </tr>`;
    for (const emp of labor.overtime) {
      ...
      html += `
    <tr>
      <td style="padding:10px 12px 10px 0;border-bottom:1px solid #1a1a1a;">
        <div style="color:#FFFFFF;font-size:14px;font-weight:700;">${emp.name}${dtBadge}</div>
        <div style="color:#555555;font-size:11px;margin-top:2px;">${fmt$(emp.wage)}/h</div>
      </td>
      <td style="padding:10px 8px;border-bottom:1px solid #1a1a1a;white-space:nowrap;">
        <span style="color:#999999;font-size:14px;">${emp.hours}h</span>
        <span style="color:#C9A84C;font-size:14px;font-weight:700;margin-left:6px;">${fmtOT(emp.otHours)}</span>
      </td>
      <td align="right" style="color:#C9A84C;font-size:14px;font-weight:700;padding:10px 0;border-bottom:1px solid #1a1a1a;white-space:nowrap;">+${fmt$(emp.extraCost)}</td>
    </tr>`;
    }
    html += `
    <tr>
      <td colspan="2" style="color:#666666;font-size:11px;padding:10px 0 2px;">Total extra labor cost</td>
      <td align="right" style="color:#C9A84C;font-size:15px;font-weight:700;padding:10px 0 2px;white-space:nowrap;">+${fmt$(labor.totalOtCost)}</td>
    </tr>
  </table>
</td></tr>
<tr><td style="height:10px;"></td></tr>`;
...
<tr><td style="height:10px;"></td></tr>`;
  ...
  // DAY AT A GLANCE
  if (chartBuffer || peakLine) {
    html += `
<!-- DAY AT A GLANCE -->
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:8px;padding:16px 16px 12px;">
  <div style="color:#666666;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:10px;">Day at a Glance</div>`;
    if (chartBuffer) {
      html += `
  <img src="cid:${chartCid}" width="508" alt="Day at a glance chart" style="display:block;max-width:100%;border-radius:4px;">`;
    } else {
      html += `
...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:8px;padding:18px 18px 10px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td width="5%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">#</td>
      <td width="65%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">ITEM</td>
      <td align="right" width="12%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">QTY</td>
      <td align="right" width="18%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">REVENUE</td>
    </tr>`;
    sales.topItems.slice(0, 10).forEach((item, i) => {
      html += `
    <tr>
      <td style="color:#555555;font-size:15px;padding:8px 4px 8px 0;">${i + 1}</td>
      <td style="color:#FFFFFF;font-size:15px;padding:8px 8px 8px 0;">${item.name}</td>
      <td align="right" style="color:#FFFFFF;font-size:15px;padding:8px 4px;white-space:nowrap;">${item.qty}</td>
      <td align="right" style="color:#C9A84C;font-size:15px;padding:8px 0 8px 4px;white-space:nowrap;">${fmt$(item.revenue)}</td>
    </tr>`;
    });
    html += `
  </table>
...
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:8px;padding:18px 18px 10px;">
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td width="70%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">ITEM</td>
      <td align="right" width="12%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">QTY</td>
      <td align="right" width="18%" style="color:#444444;font-size:10px;font-weight:700;padding-bottom:8px;border-bottom:1px solid #222222;">REVENUE</td>
    </tr>`;
...
<tr><td style="height:10px;"></td></tr>`;
  ...
  if (voids.count > 0) {
    html += `
<!-- VOIDS -->
<tr><td bgcolor="#13131A" style="background-color:#13131A;border-radius:8px;padding:16px 20px;">
  <div style="color:#FF6B6B;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px;">Voids</div>
  <div style="color:#FFFFFF;font-size:15px;">${voids.count} voided order${voids.count !== 1 ? 's' : ''} &nbsp;&middot;&nbsp; <span style="color:#FF6B6B;">${fmt$(voids.totalAmount)}</span> total</div>
</td></tr>
<tr><td style="height:10px;"></td></tr>`;
  }
...
<tr><td align="center" style="padding:20px 0 4px;">
  ...
  const attachments = chartBuffer
    ? [{ filename: 'chart.png', content: chartBuffer, cid: chartCid }]
    : [];
