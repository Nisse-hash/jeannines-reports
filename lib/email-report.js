...
<tr><td style="padding:${li === 0 ? '0' : '16px'} 0 14px;">
  <div style="text-align:center;">
    ...
    // Open left-stripe wrapper for this location's content
    html += `
<tr><td style="padding-bottom:8px;">
  <table width="100%" cellpadding="0" cellspacing="0"><tr>
    <td width="4" valign="top" style="background-color:${locColor};border-radius:3px;">&nbsp;</td>
