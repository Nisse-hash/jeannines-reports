...
<tr><td style="height:10px;"></td></tr>`;
    ...
    const laborPctHtml = `${laborPct}<div style="color:#666666;font-size:12px;font-weight:400;margin-top:8px;line-height:1.4;">+ cleaning crew remaining<br>after this report is sent</div>`;
    html += `
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0">
    ...
    ${metricRow('Tips', fmt$(sales.tipTotal), 'Labor / Sales', laborPctHtml)}
  </table>
</td></tr>
<tr><td style="height:20px;"></td></tr>`;
