...
<tr><td style="height:10px;"></td></tr>`;
    ...
    const laborNote = `<span style="font-size:9px;color:#888888;line-height:1.5;">Staff &middot; Cleaning &middot; Bakery (9) &middot; Maintenance${managerName ? `<br><span style="color:#555555;font-weight:600;">${managerName}</span>` : ''}</span>`;
    html += `
